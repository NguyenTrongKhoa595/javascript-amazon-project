...
import {products, gerProduct} from '../../data/products.js';
...
export function renderOrderSummary(){
    ...
    cart.forEach((cartItem) => {
        ...
        const matchingProduct = gerProduct(productId);
    ...
    // To display the number of item in the cart, for the header section.
    ...
    function handleUpdateQuantity(productId, quantityInput){
        ...
        // Click save then return to normal Update | Delete
        const container = document.querySelector(`.js-cart-item-container-${productId}`);
        container.classList.remove('is-editing-quantity');
        // Update the quantiy for the header and container in HTML
